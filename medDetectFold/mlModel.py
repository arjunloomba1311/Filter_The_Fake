...
def implementModel(pathway):
    ...
    net = cv2.dnn.readNet("/Users/maheshjain/Desktop/medDetectFold/medDetectFold/yolov3_custom_last1.weights", "/Users/maheshjain/Desktop/medDetectFold/medDetectFold/yolov3_custom.cfg")
    classes = []
    with open("/Users/maheshjain/Desktop/medDetectFold/medDetectFold/classes.txt", "r") as f:
    ...
    #resize and fix image parameters
    ...
    # cv2.imshow('rect',rgb)
    path = '/Users/maheshjain/Desktop/medDetectFold/main/static'
    cv2.imwrite(os.path.join(path , "detectionImage.jpg"), rgb)
    # cv2.waitKey(0)


    #define the contonouu
    ...
    if len(misspelled) == 0:
        ...
        final_count.append('0')
        warning.append("Spelling errors were found on the package")
    ...
    percentage_certainty.clear()
    percentage_certainty.append(int((number/final_count_length)*100))
